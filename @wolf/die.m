...
%death function for class wolf
%agt=wolf object
%cn - current agent number
%klld=1 if agent dies, =0 otherwise

%wolfes die if their food level reaches zero or they are older than max_age
...
%frequency parameters for both wolfes and rabbits
